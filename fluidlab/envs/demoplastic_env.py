...
class DemoPlasticEnv(FluidEnv):
    ...
    def setup_bodies(self):
        for i in range(30):
            ...
            if type == 'mesh':
                file = 'duck.obj'
                pos = np.random.uniform([0.2, 0.3, 0.2], [0.8, 0.6, 0.8])
                ...
                lower = np.random.uniform([0.2, 0.5, 0.2], [0.8, 0.85, 0.8])
                ...
                center = np.random.uniform([0.2, 0.5, 0.2], [0.8, 0.85, 0.8])
